...
chat_id: "create-agents-instructions-20251021"
prompt: |
  Generate comprehensive authoring guidelines for creating custom GitHub Copilot agents
  following repository standards and best practices.
started: "2025-10-21T19:30:00Z"
ended: "2025-10-21T19:45:00Z"
task_durations:
  - task: "analyze existing agents"
    duration: "00:05:00"
  - task: "generate comprehensive instructions"
    duration: "00:10:00"
total_duration: "00:15:00"
ai_log: "ai-logs/2025/10/21/create-agents-instructions-20251021/conversation.md"
source: ".github/prompts/create-agents-instructions.prompt.md"
applyTo: "**/*.agents.md"
---

# Custom agent Authoring Instructions

## Overview and Purpose

Custom agents are specialized AI assistants that extend GitHub Copilot's capabilities for specific domains, workflows, or tasks. They allow teams to create focused, context-aware AI helpers with tailored expertise, personality, and command structures.

### What Are Custom agents?

Custom agents are Markdown-based configuration files that define:
...
Custom agents integrate seamlessly with GitHub Copilot:

- **Activation**: Use `@<modename>` to activate a specific agent
- **Commands**: Invoke mode-specific commands like `@security-scan` or `@overview`
- **Context**: agents leverage repository context and open files
...
**Pattern**: `<ChatModeName>.agents.md`

**Rules**:

- Use PascalCase for the mode name: `SecurityAnalyzer.agents.md`
- Include `.agents.md` extension (required for recognition)
...
```
✅ SecurityAnalyzer.agents.md
✅ DocDesignArchitect.agents.md
✅ CodebaseExplorer.agents.md
✅ GitFlowStrategist.agents.md

❌ security.agents.md          # Not descriptive enough
❌ security_analyzer.agents.md # Use PascalCase, not snake_case
❌ SecurityAnalyzerMode.md       # Missing .agents extension
```

### File Location

**Standard Location**: `.github/agents/`

```
repository-root/
├── .github/
│   ├── agents/               # agent files go here
│   │   ├── SecurityAnalyzer.agents.md
│   │   ├── DocDesignArchitect.agents.md
│   │   └── CodebaseExplorer.agents.md
...
Every agent file must start with these header fields:
...
**Purpose**: The display name shown in GitHub Copilot when activating the agent.
...
**Purpose**: Clearly defines the agent's primary role and value proposition.
...
Before submitting a agent file, verify:
...
- [ ] File has `.agents.md` extension
- [ ] File located in `.github/agents/`
...
1. **Manual Testing**:
   - Activate the agent in GitHub Copilot (`@<modename>`)
...
2. **Peer Review**:
   - Have a colleague use the agent
...
1. Read the entire agent file aloud
...
Use this template for straightforward, single-purpose agents:
...
**Example** (based on `DocDesignArchitect.agents.md`):
...
Use this template for comprehensive, command-driven agents:
...
```markdown
[agent with no guidance on response style or behavior]
...
**Activating a agent in GitHub Copilot**:
...
3. **Context Awareness**:
   - agents have access to open files
...
### Combining agents with Other Copilot Features

**Integration Points**:

1. **Inline Suggestions**: agents enhance context for code completion
2. **Code Actions**: Use agent insights to guide refactoring
3. **Workspace Context**: agents leverage open files and project structure
4. **Terminal Integration**: Execute suggested commands directly
5. **GitHub Integration**: Create issues, manage PRs from agent output
...
For complex or specialized agents, create companion README files:

**README Location**: `.github/agents/README-<ModeName>.md`
...
- Main mode: `SecurityAnalyzer.agents.md`
- README: `.github/agents/README-SecurityAnalyzer.md`

## Maintenance and Evolution

### Versioning

While agent files don't have explicit version fields, track evolution through:

**Git Commits**:

```
feat(agents): add SecurityAnalyzer with OWASP commands
fix(agents): clarify SecurityAnalyzer command descriptions
docs(agents): add examples to SecurityAnalyzer
```
...
- [ ] Researched existing agents to avoid duplication
...
- [ ] Created file in `.github/agents/`
- [ ] Named file using PascalCase with `.agents.md` extension
...
- [ ] Added to agent catalog (if exists)
...
Create `ai-logs/2025/10/21/create-agents-instructions-20251021/conversation.md` with:

```markdown
# AI Conversation Log

- Chat ID: create-agents-instructions-20251021
- Operator: johnmillerATcodemag-com
- Model: anthropic/claude-3.5-sonnet@2024-10-22
- Started: 2025-10-21T19:30:00Z
- Ended: 2025-10-21T19:45:00Z
...
- Inputs: `.github/prompts/create-agents-instructions.prompt.md`
- Targets: `.github/instructions/create-agents.instructions.md`
...
\`\`\`text
#file:create-agents-instructions.prompt.md
\`\`\`

[2025-10-21T19:35:00Z] anthropic/claude-3.5-sonnet@2024-10-22

\`\`\`text
I'll execute the prompt to generate comprehensive instructions for creating custom GitHub Copilot agents.
[Reads existing agent files for reference patterns]
\`\`\`

[2025-10-21T19:45:00Z] anthropic/claude-3.5-sonnet@2024-10-22

\`\`\`text
Created comprehensive agent authoring instructions at:
...
- `.github/instructions/create-agents.instructions.md` - Comprehensive authoring guidelines for custom agents

**Next Steps**:

- [ ] Update README.md with link to new instruction file
- [ ] Create summary.md for this session
- [ ] Test instructions by creating a new agent

**Duration Summary**:

- Analyze existing agents: 00:05:00
...
Create `ai-logs/2025/10/21/create-agents-instructions-20251021/summary.md` following the template in `ai-assisted-output.instructions.md`.
...
- [`.github/instructions/create-agents.instructions.md`](.github/instructions/create-agents.instructions.md) — Comprehensive authoring guidelines for creating custom GitHub Copilot agents ([chat log](ai-logs/2025/10/21/create-agents-instructions-20251021/conversation.md))
```
